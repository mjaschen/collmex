...
// Create a random negative number when importing multiple items. Otherwise Collmex creates a new order for every single product / item
$customerOrderItem1 = new CustomerOrder(
    [
        'client_id'                      => '2',
        'order_id'                       => random_int( - 1000, 0 ),
        'position'                       => null,
        'order_type'                     => null,
        ...
        'product_id' => '12345',
